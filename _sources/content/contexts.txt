...
The `Finagle documentation on Contexts`_ gives a good introduction and describes multiple use cases. They can be used
to transport request meta data or application-wide context like authentication data.

From the Finagle documentation:

.. note:: Contexts can be either local or broadcast. Local contexts do not cross process boundaries while broadcast
...
A context is described and typed by a `Key`_. The `Contexts`_ object provides the necessary context instances to create
a Key.
...
.. _Finagle documentation on Contexts: https://twitter.github.io/finagle/guide/Contexts.html
.. _Contexts: https://twitter.github.io/finagle/docs/#com.twitter.finagle.context.Contexts$
.. _Key: https://twitter.github.io/finagle/docs/index.html#com.twitter.finagle.context.Context@Key[A]
